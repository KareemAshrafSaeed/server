...
enum enum_binlog_state
{
  ...
  */
  ...
  BINLOG_STATE_BYPASS=        (1<<4),   // OPTION_BIN_LOG is not set
  BINLOG_STATE_FILTER=        (1<<5),   // Database filtering used
...
#define BINLOG_STATE_DISABLED_WSREP (BINLOG_STATE_FILTER | BINLOG_STATE_READONLY)
